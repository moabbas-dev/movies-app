  ...
  return (
      <header className="w-full h-20 flex items-center text-gray-700 bg-white border-t border-gray-100 shadow-sm body-font">
        <div className="container flex flex-col flex-wrap items-center mx-auto md:flex-row">
          ...
          <a className="flex justify-center items-center order-first mb-4 font-medium text-gray-900 lg:order-none lg:w-1/5 title-font lg:items-center lg:justify-center md:mb-0">
